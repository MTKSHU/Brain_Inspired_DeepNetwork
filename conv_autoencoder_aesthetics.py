...
transform = transforms.Compose(
    [transforms.ToTensor(), transforms.Normalize((mean_r, mean_g, mean_b), (std_r, std_g, std_b))])
BatchSize = 128

trainset = AVA_Dataset_All(root_dir=path + "images/resized_images_320_320_padded_white/", transform=transform)
